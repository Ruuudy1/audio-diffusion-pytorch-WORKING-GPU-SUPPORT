# Credits to the original repository, I just added: GPU support, Command-line argument support for key parameters, executable scripts, Presets for common generation scenarios (quick/standard/high-quality), + documentation for my personal use. 
